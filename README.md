...
6. If you defined your VAE and AE, put in all the parameters and just run file "main_train_ae.py" to start training the auto encoders parameters
7. Afterwards the VAE can be trained by loading in the spreading trained AE parameters, then you can execute code file "main_train_vae.py".
8. If your training ended and stopped automatically you can run file "main_evaluate.py"
9. Now everything is finished and you should see your results and plots.
