...
input_data = "/Users/zarahaigner/Documents/Arbeit/VAE_H2O_30Beads/data/VAE_data_reconstructed_30Beads.xyz"
output_data_file = "Energies_VAE_kinetic_30beads.csv" 

simulation_dim = 3  # three dimensions -> 3 coordinates per atom
numParticles = 3   # number of beads per configuration
numTimeSlices = 30   # number of atoms per bead/molecule
T = 1               # Kelvin
