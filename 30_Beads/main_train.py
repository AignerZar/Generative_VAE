...
torch.save(model.state_dict(), "vae_h2o_30Beads_new.pt")

plot_loss(loss_history, outfile="loss_plot_30Beads_new.pdf")    # adjusting all the names and storing everything separatedly 